...
from core.models import load_viclip
...
def _motion_search(query: str, top_k: int = 5) -> list:
    ...
    if not all_clusters:
        return [{"action_label": query, "note": "no matching motion found in any video in the library"}]
